...
$urlSuccess = $this->createUrl('patient/success', array('id' => 1));
?>
...
<div id="section_container">
    <section id="centerIntention_section" class="active" data-init="true">
        <header>
            <nav class="left">
            ...
            <div class="ml10 mr10 mt20 mb20">
                <form action="<?php echo $urlSuccess; ?>" method="post">
                    ...
                    <div class="text-center mt40 btn-none">
                        <input type="submit" class="btn-green pl20 pr20 pt10 pb10 font-type h50 text-center" value="提交预约" />
                    </div>
                </form>
            </div>
        </article>
