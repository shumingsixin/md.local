...
$urlView = $this->createUrl('patient/view', array('id'=>1));
?>
...
<section id="updateCase_section" class="active" data-init="true">
	<header>
		<nav class="left">
	...
	<article class="active" data-scroll="true">
		<div class="ml10 mr10 mt20 mb20">
			<form action="<?php echo $urlView; ?>" method="post">
				...
				<div class="text-center mt40 btn-none">
                                    <input type="submit" class="btn-green pl50 pr50 pt10 pb10 font-type h50 text-center" value="保存" />
				</div>
			</form>
