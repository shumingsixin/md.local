...
<html lang="zh" xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . '/css/formNew.css?ts=' . time());
        Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . '/css/app.css');
        Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . '/css/mdNew.css?ts=' . time());
//        Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . '/css/common.min.css?ts=' . time());
        ...
        Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . '/js/lib/Jingle.customNew.js?ts=' . time(), CClientScript::POS_END);
